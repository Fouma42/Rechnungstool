...
public class PdfCreator {
	...
	public String createPdf(Kunde kunde, ArrayList<Angebotspositionen> positionen, String user) throws IOException {
		String path = PdfHelper.path + kunde.getVorname() + "_" + kunde.getNachName() + "_" + PdfHelper.getCurrentDate()
				+ "_" + kunde.getRechnungsNummer() + ".pdf";
		...
		if (user.equals("Momo")) {
			...
			cos.showText("Momos Fensterputz");
			cos.endText();
		}

		createadress(cos, kunde, user);
		addStartText(cos, kunde);
		drawRectangle(cos);
		addOfferCredentials(cos, kunde, positionen);
		addlastText(cos, user);
		footer(cos, user);
		cos.close();
		document.save(path);
		document.close();
	...
	public void createadress(PDPageContentStream cos, Kunde kunde, String user) throws IOException {
		cos.beginText();
		...
		cos.showText(user.equals("Momo") ? "Muammer Dalkilic" : "Hatun Dalkilic");
		cos.endText();

		cos.beginText();
		cos.setFont(PdfHelper.FONT_DEFAULT, 12);
		cos.newLineAtOffset(PdfHelper.RAND_LINKS_ADRESSZEILE,
				PdfHelper.OBEN_BEGIN_ABSENDER_ADRESSZEILE - PdfHelper.DEFAULT_TEXT_COLUMN);
		...
		cos.setFont(PdfHelper.FONT_DEFAULT, 12);
		cos.newLineAtOffset(PdfHelper.RAND_LINKS_ADRESSZEILE,
				PdfHelper.OBEN_BEGIN_ABSENDER_ADRESSZEILE - (2 * PdfHelper.DEFAULT_TEXT_COLUMN));
		...
		cos.setFont(PdfHelper.FONT_DEFAULT, 12);
		cos.newLineAtOffset(PdfHelper.RAND_LINKS_ADRESSZEILE,
				PdfHelper.OBEN_BEGIN_ABSENDER_ADRESSZEILE - (3 * PdfHelper.DEFAULT_TEXT_COLUMN));
		cos.showText(user.equals("Momo") ? "Tel: 01577/1928653" : "Tel: 01577/2042393");
		cos.endText();

		cos.beginText();
		cos.setFont(PdfHelper.FONT_DEFAULT, 12);
		cos.newLineAtOffset(PdfHelper.RAND_LINKS_ADRESSZEILE,
				PdfHelper.OBEN_BEGIN_ABSENDER_ADRESSZEILE - (4 * PdfHelper.DEFAULT_TEXT_COLUMN));
		cos.showText(user.equals("Momo") ? "E-mail: info@momos-fensterputz.de" : "E-mail: h.dalkilic@outlook.de");
		cos.endText();
		...
		if (user.equals("Momo")) {
			...
			cos.setFont(PdfHelper.FONT_DEFAULT, 12);
			cos.newLineAtOffset(PdfHelper.RAND_LINKS_ADRESSZEILE,
					PdfHelper.OBEN_BEGIN_ABSENDER_ADRESSZEILE - (5 * PdfHelper.DEFAULT_TEXT_COLUMN));
		...
		cos.setFont(PdfHelper.FONT_DEFAULT, 12);
		cos.newLineAtOffset(PdfHelper.RAND_LINKS_ADRESSZEILE,
				PdfHelper.OBEN_BEGIN_EMPFAENGER_ADRESSZEILE - (1 * PdfHelper.DEFAULT_TEXT_COLUMN));
		...
		cos.setFont(PdfHelper.FONT_DEFAULT, 12);
		cos.newLineAtOffset(PdfHelper.RAND_LINKS_ADRESSZEILE,
				PdfHelper.OBEN_BEGIN_EMPFAENGER_ADRESSZEILE - (2 * PdfHelper.DEFAULT_TEXT_COLUMN));
		...
		cos.setFont(PdfHelper.FONT_DEFAULT, 12);
		cos.newLineAtOffset(PdfHelper.RAND_LINKS_ADRESSZEILE,
				PdfHelper.OBEN_BEGIN_EMPFAENGER_ADRESSZEILE - (3 * PdfHelper.DEFAULT_TEXT_COLUMN));
		...
		cos.setFont(PdfHelper.FONT_DEFAULT, 12);
		cos.newLineAtOffset(PdfHelper.RAND_LINKS_ADRESSZEILE,
				PdfHelper.OBEN_BEGIN_EMPFAENGER_ADRESSZEILE - (6 * PdfHelper.DEFAULT_TEXT_COLUMN));
		cos.showText("Datum: " + PdfHelper.getCurrentDate());
		cos.endText();

		cos.beginText();
		cos.setFont(PdfHelper.FONT_DEFAULT_BOLD, 12);
		cos.newLineAtOffset(PdfHelper.RAND_LINKS_ADRESSZEILE + 300,
				PdfHelper.OBEN_BEGIN_EMPFAENGER_ADRESSZEILE - (6 * PdfHelper.DEFAULT_TEXT_COLUMN));
	...
	void addOfferCredentials(PDPageContentStream contentStream, Kunde kunde, ArrayList<Angebotspositionen> positionen)
			throws IOException {
	...
	void addlastText(PDPageContentStream contentStream, String user) throws IOException {
		...
		contentStream.showText("Mit freundlichen Grüßenen");
		contentStream.endText();

		contentStream.setFont(PdfHelper.FONT_DEFAULT, PdfHelper.FONT_SIZE_DEFAULT);
		contentStream.beginText();
		contentStream.newLineAtOffset(PdfHelper.RAND_LINKS_DEFAULT, startEndText - 120);
		contentStream.showText(user.equals("Momo") ? "Muammer Dalkilic" : "Hatun Dalkilic");
		contentStream.endText();
	...
	void addStartText(PDPageContentStream contentStream, Kunde kunde) throws IOException {
		...
		contentStream
				.showText("Ich erlaube mir folgende Leistungen für meine Dienstleistungen in Rechnung zu stellen.");
		contentStream.endText();

	}

	void footer(PDPageContentStream contentStream, String user) throws IOException {
